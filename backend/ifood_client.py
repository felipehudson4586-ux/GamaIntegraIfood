...
class IFoodClient:
    ...
    async def authenticate(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("Token iFood obtido com sucesso")
            return {
                "access_token": self._access_token,
                "expires_at": self._token_expires_at.isoformat(),
    ...
    async def poll_events(self, categories: List[str] = None, groups: List[str] = None) -> Dict[str, Any]:
        ...
        Categories: FOOD, GROCERY, ANOTAI, FOOD_SELF_SERVICE, ALL
        Groups: STATUS, DELIVERY, HANDSHAKE, etc.
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
        
        # Adiciona header de merchants se configurado
        if self.merchant_id:
    ...
    async def get_cancellation_reasons(self) -> List[Dict[str, Any]]:
        ...
        Endpoint: GET /order/v1.0/orders/cancellationReasons
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
        ...
        try:
            response = await client.get(
                f"{self.BASE_URL}/order/v1.0/orders/cancellationReasons",
                headers=headers
            )
            response.raise_for_status()
            return response.json()
    ...
    async def get_items(self, merchant_id: str = None) -> List[Dict[str, Any]]:
        ...
        Endpoint: GET /catalog/v2.0/merchants/{merchantId}/items
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
        mid = merchant_id or self.merchant_id
    ...
    async def create_item(self, item_data: Dict[str, Any], merchant_id: str = None, reset: bool = False) -> Dict[str, Any]:
        ...
        reset=false: adiciona item / reset=true: atualização completa (destrutiva)
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
        mid = merchant_id or self.merchant_id
    ...
    async def update_item(self, item_id: str, updates: Dict[str, Any], merchant_id: str = None) -> Dict[str, Any]:
        """
        Atualiza item existente (preço, estoque, etc.)
        Endpoint: PATCH /catalog/v2.0/merchants/{merchantId}/items/{itemId}
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
        mid = merchant_id or self.merchant_id
    ...
    async def start_separation(self, order_id: str) -> Dict[str, Any]:
        ...
        Endpoint: POST /order/v1.0/orders/{id}/startSeparation
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
    ...
    async def end_separation(self, order_id: str) -> Dict[str, Any]:
        ...
        Endpoint: POST /order/v1.0/orders/{id}/endSeparation
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
    ...
    async def add_picking_item(self, order_id: str, item_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Endpoint: POST /order/v1.0/orders/{id}/picking/items
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
    ...
    async def modify_picking_item(self, order_id: str, unique_id: str, modifications: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Endpoint: POST /order/v1.0/orders/{id}/picking/items/{uniqueId}
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
    ...
    async def replace_picking_item(self, order_id: str, unique_id: str, replacement: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Endpoint: POST /order/v1.0/orders/{id}/picking/items/{uniqueId}/replace
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
    ...
    async def remove_picking_item(self, order_id: str, unique_id: str) -> Dict[str, Any]:
        ...
        Endpoint: DELETE /order/v1.0/orders/{id}/picking/items/{uniqueId}
        """
        client = await self._get_http_client()
        headers = await self._get_headers()
